...
int input_read_parameters_species(struct file_content * pfc,
  ...
  // #mod
  class_read_int("model_type",ppt->model_type);
  class_read_double("inverse_omega",ppt->inverse_omega);
  class_read_double("scalmass_in_planck",ppt->scalmass_in_planck);
